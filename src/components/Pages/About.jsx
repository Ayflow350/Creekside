...
const teamData = [
  {
    imgUrl: 'images/contact/lopi.svg',
    name: 'James Lee, MD',
  ...
  {
    imgUrl: 'images/about/yetty 1.svg',
    name: 'Angela Brown',
...
const galleryData = [
  ...
  { imgUrl: '/images/weee.jpeg' },
  { imgUrl: '/images/aboutee.jpeg' },
  { imgUrl: '/images/oldOnes.jpeg' },
  { imgUrl: '/images/deeee.jpeg' },
];
const awardData = [
  {
...
export default function About() {
  ...
  return (
    <>
      <BannerSectionStyle3
        bgUrl="/images/new.svg"
        imgUrl="/images/agency.svg"
        title="Welcome to <br />Creekside Incoporation"
      ...
      <Section topMd={175} topLg={125} topXl={85} bottomMd={100} bottomLg={110}>
        <FeaturesSectionStyle2
          ...
          imgUrl="images/aboutee1.jpeg"
          data={featureListData}
        />
      </Section>
      <Section>
        <FunFactSection
          bgUrl="images/about.png"
          data={funFactData}
        />
      </Section>
      <Section topMd={190} topLg={145} topXl={105}>
        <TeamSection
          sectionTitle="Healthcare Professionals"
